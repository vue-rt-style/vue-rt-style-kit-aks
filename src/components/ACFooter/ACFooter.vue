                        ...
                        <div class="conference-footer__top">
                            <div class="current-time">
                                <div class="current-time__current-location">
                                    <div class="now__date">8 мая 2020</div>
                                ...
                                <div class="current-time__chosen-location">
                                    <div class="now__time">13 : 49</div>
                                    <div class="current-time__location">Новосибирск</div>
                                </div>
                                <div class="current-time__chosen-location">
                                    <div class="now__time">13 : 49</div>
                                    <div class="current-time__location">Красноярск</div>
                                </div>
                                <div class="current-time__chosen-location">
                                    <div class="now__time">13 : 49</div>
                                    <div class="current-time__location">Тула</div>
                                </div>
                                <div class="current-time__chosen-location">
                                    <div class="now__time">13 : 49</div>
                                    <div class="current-time__location">Иркутск</div>
                                </div>
                                            ...
                                            <g transform="translate(-814.000000, -28.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                                <g transform="translate(370.000000, 20.000000)">
                                                    <g transform="translate(432.000000, 1.000000)">
                                                        <path d="M23,12 L21,12 L21,16 L17,16 L17,18 L21,18 L21,22 L23,22 L23,18 L27,18 L27,16 L23,16 L23,12 Z M22,7 C16.48,7 12,11.48 12,17 C12,22.52 16.48,27 22,27 C27.52,27 32,22.52 32,17 C32,11.48 27.52,7 22,7 Z M22,25 C17.59,25 14,21.41 14,17 C14,12.59 17.59,9 22,9 C26.41,9 30,12.59 30,17 C30,21.41 26.41,25 22,25 Z" id="Shape"></path>
                                                    </g>
                                                </g>
                                            </g>
                                        </g>
                            ...
                            <a href="#" class="conference-footer__help-link">Нужна помощь?</a>
                        </div>
                        <div class="conference-footer__bottom color-white05">
                            <div class="conference-footer__about">
                                <span>Узнать больше</span>
                                <a href="" class="color-white"> об услуге Аудиоконференция
                            ...
                            <div class="conference-footer__legal">
                                <span class="conference-footer__copyright">© 2020 ПАО «Ростелеком». 18+.</span>
                                <span class="conference-footer__phone">8 800 100 0 800</span>
                            </div>
                        </div>
                    </div>
                </div>
