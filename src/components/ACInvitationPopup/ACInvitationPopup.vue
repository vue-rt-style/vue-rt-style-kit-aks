                ...
                <div class="popup-content">
                    ...
                    <rt-tabs class="bordered-tabs">
                        ...
                        <template slot="content">
                            ...
                            <rt-tabs-content-item name="ac5"></rt-tabs-content-item>
                        </template>
                    </rt-tabs>
                    <div class="sp-t-1-3">
